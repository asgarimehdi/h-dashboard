...
/**
 * HR Org Chart API endpoints (Issue #223) — for the Flutter app and HR dashboard.
 * Stats and analytics are in HrStatsController and HrAnalyticsController respectively.
 */
